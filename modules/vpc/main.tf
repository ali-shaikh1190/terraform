...
resource "aws_subnet" "public" {
  ...
  tags = "${merge(var.tags, var.public_subnet_tags, map("Name", format("%s-public-%s-%s", var.name, element(var.az_no_public, count.index), element(var.azs, count.index))))}"
}
...
resource "aws_subnet" "private" {
  ...
  tags = "${merge(var.tags, var.private_subnet_tags, map("Name", format("%s-private-%s-%s", var.name, element(var.az_no_private, count.index), element(var.azs, count.index))))}"
}
...
resource "aws_subnet" "database" {
  ...
  tags = "${merge(var.tags, var.database_subnet_tags, map("Name", format("%s-db-%s-%s", var.name, element(var.az_no_db, count.index), element(var.azs, count.index))))}"
}
...
resource "aws_subnet" "redshift" {
  ...
  tags = "${merge(var.tags, var.redshift_subnet_tags, map("Name", format("%s-redshift-%s-%s", var.name, element(var.az_no_rs, count.index), element(var.azs, count.index))))}"
}
...
resource "aws_subnet" "elasticache" {
  ...
  tags = "${merge(var.tags, var.elasticache_subnet_tags, map("Name", format("%s-elasticache-%s-%s", var.name, element(var.az_no_rs, count.index) , element(var.azs, count.index))))}"
}
